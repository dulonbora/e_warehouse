...
$response = array();
$response["SUCCESS"] = 0;
$_v            = filter_input(INPUT_GET , "v");
$_Status            = filter_input(INPUT_GET , "s");


$TotalRow = $_Ledger_Account->TotalCountbyStatusAndVchType($userId, $_Status, $_v);
$limit = 20;
...
$Result = $_Ledger_Account->loadAllPaggingbyStatusAndVchType($start, $limit, $userId, $_Status, $_v);
