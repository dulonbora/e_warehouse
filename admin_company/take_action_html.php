        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group"> <label>Officers Name</label> 
                    <input type="text" name="OFFICERS_NAME" id="OFFICERS_NAME" value="<?php echo $__company->getGstn(); ?>" id="GSTN" placeholder="Officers Name" class="input-sm form-control" required disabled>
                    <input type="hidden" name="MODULE_TYPE" value="COM">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group"> <label>NOTE</label>
                    <input type="text" name="NOTE" id="NOTE" value="<?php echo $__company->getGstn(); ?>" id="GSTN" placeholder="Note" class="input-sm form-control" required>
                </div>
            </div>
