...
$TotalRow = $_brandMaster->TotalCountByUser($i);
$limit = 20;
...
$Result = $_brandMaster->loadAllPaggingByUser($i, $start, $limit);
if ($Result > 0) {
    ...
    foreach ($Result as $rows) {
        ...
        $Edict['USER_ITEM_STATUS']          = $rows['USER_ITEM_STATUS']     == 1 ? "Active" : "Active";
