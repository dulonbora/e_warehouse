...
$TotalRow = $_Brand__List__User_View_Role->TotalCount($_t);
$limit = 20;
...
$Result = $_Brand__List__User_View_Role->loadAllPagging($_t, $start, $limit);
if ($Result > 0) {
    $response['CONTENTS'] = array();
    $Edict = array();
    foreach ($Result as $rows) {
        $_Brand__List__User_View_Role->LoadValue($rows['ID']);
