...
public function Work($tittle){
    ...
    echo '<header class="bg-success lter header header-md navbar navbar-fixed-top-xs"> 
        ...
        <ul class="nav navbar-nav m-n hidden-xs nav-user user"> 
            ...
            <li class="dropdown"> 
                <a href="#" class="dropdown-toggle bg clear" data-toggle="dropdown">
                    <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm"> <img src="../images/'.$_SESSION["COMPANY_LOGO"].'" alt="...">
...
public function Workl($tittle){
    ...
    echo '<header class="bg-white-only header header-md navbar navbar-fixed-top-xs"> 
                    ...
                    <section class="panel bg-white"> 
                        ...
                        <div class="list-group list-group-alt"> 
                            <a href="#" class="media list-group-item"> 
                                ...
                                <span class="media-body block m-b-none"> Use awesome animate.css<br> <small class="text-muted">10 minutes ago</small> </span> </a> 
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle bg clear" data-toggle="dropdown"> 
                    ...
                    <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm"> 
                        <img src="images/a0.png" alt="..."> </span> John.Smith <b class="caret"></b> 
                </a> 
                <ul class="dropdown-menu animated fadeInRight">
                    <li> 
                        <span class="arrow top"></span> <a href="#">Settings</a> 
                    </li> 
