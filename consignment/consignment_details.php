                                    ...
                                    <div class="col-lg-12">
                                        <section class="panel panel-default">
                                            <header class="panel-heading">Consignment Detrails
                                                <a href="../excise/apply_transport_permit.php?i=<?php echo $_id;?>" class="btn btn-danger btn-xs btn-rounded pull-right">Apply Permit</a>
                                                <?php
                                                
                                                if($Transfar_Master->getCreate_by()==$userId){ ?>
                                                        <?php if($Transfar_Master->getStatus()==1){ ?>
                                                        <a href="../consignment_ajax_request/change_consignment_status.php?i=<?php echo $_id;?>" class="btn btn-success btn-rounded btn-xs pull-right">
                                                            Confirm This Consignment
                                                        </a>
                                                        <?php }?>
                                                        
                                                        <?php if($Transfar_Master->getStatus()==2){ ?>
                                                        <a href="../consignment_ajax_request/change_consignment_status.php?i=<?php echo $_id;?>" class="btn btn-success btn-xs btn-rounded pull-right">Send To Consignor</a>
                                                        <?php }?>
                                                        
                                                        <?php }?>
                                                        <?php if($Transfar_Master->getUser_from()==$userId){ ?>
                                                        <?php if($Transfar_Master->getStatus()==3){ ?>
                                                        <a href="../consignment_ajax_request/change_consignment_status.php?i=<?php echo $_id;?>" class="btn btn-danger btn-xs btn-rounded pull-right">Reject</a>
                                                        <a href="../consignment_ajax_request/change_consignment_status.php?i=<?php echo $_id;?>" class="btn btn-success btn-xs  btn-rounded pull-right">Confirm This Order</a>
                                                        <?php }?>
                                                        <?php if($Transfar_Master->getStatus()==5 && $Transfar_Master->getUser_to()==$_SESSION['id']){ ?>
                                                        <a href="../consignment_ajax_request/change_consignment_status.php?i=<?php echo $_id;?>" class="btn btn-danger btn-xs btn-rounded pull-right">Apply Permit</a>
                                                        <?php }?>
                                                        <?php if($Transfar_Master->getStatus()==5){ ?>
                                                        <a href="../consignment_ajax_request/change_consignment_status.php?i=<?php echo $_id;?>" class="btn btn-danger btn-xs btn-rounded pull-right">Dispatched This Consignment</a>
                                                        <?php }?>
                                                        
                                                        <?php }?>
                                                        <?php if($Transfar_Master->getStatus()==6){ ?>
                                                        <?php if($Transfar_Master->getCreate_by()==$userId){ ?>
                                                        <a href="../consignment_ajax_request/consignment_executor.php?i=<?php echo $_id;?>" class="btn btn-danger btn-xs btn-rounded pull-right">Executed This Consignment</a>
                                                            <?php }?>
                                                            <?php }?>
