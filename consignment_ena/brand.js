...
function selectConsignMent() {
    ...
    $(document).on("change", "#CONSIGNMENT_TYPE", function () {
        ...
        var url = "../consignment_ajax_request_ena/transfar_master_add.php";
        $.ajax({
            type: "POST",
            url: url,
            data: {USER_FROM : oid, MODE : consignment_type}, // serializes the form's elements.
...
function addBrandToMyList() {
    $(document).on("click", "#addItemToMyConsignMent", function (e) {
        e.preventDefault();
        var url = "../consignment_ajax_request_ena/transfar_item_add.php";
        $.ajax({
            type: "POST",
            url: url,
...
function loadTable() {
    var url = "../brand_manager_ajax/load_brand_list_by_user_id.php?i="+oid;
    alert(url);
    $.ajax({
        type: "GET",
        url: url,
...
function loadConsignMentTable(i) {
    var url = "../consignment_ajax_request_ena/load_brand_list_by_master_id.php?i="+i;
    $.ajax({
        type: "GET",
        url: url,
        success: function (data) {
