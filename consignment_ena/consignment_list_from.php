...
<body class="">
    ...
    <section class="vbox">
        <?php echo $UI->Work("ENA ORDERS"); ?>
        <section>
            <section class="hbox stretch">
                <!-- .aside -->
                <?php echo $N->ConsignmentEnaOrders(); ?>
                <!-- /.aside -->
                <section id="content">
                    <section class="vbox">
...
<ul class="breadcrumb"> 
    ...
    <li><a href="../consignment_ena/consignment_list_from.php?s=<?php echo $_Status;?>"><i class="fa fa-list-ul"></i> <?php echo $Transfar_Master->StatusForOrder($_Status);?> ENA Orders</a></li>
</ul>                              
</div>

                                    <div class="col-lg-12">
                                        <section class="panel panel-default">
                                            <header class="panel-heading"><?php echo $Transfar_Master->StatusForOrder($_Status);?> ENA Orders
                                            </header>     
...
<script src="consignment_list_fro.js"></script>
</body>
