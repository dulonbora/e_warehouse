...
<ul class="breadcrumb"> 
    ...
    <li><a href="../consignment_ena/index.php"><i class="fa fa-list-ul"></i> ENA Consignment List</a></li>
    <li><a href="../consignment_ena/consignor_list.php"><i class="fa fa-list-ul"></i> ENA Consignnor List</a></li>
</ul>                                         
