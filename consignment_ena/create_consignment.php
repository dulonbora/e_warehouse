                            ...
                            <div class="container-fluid">
                                ...
                                <li><a href="../consignment/create_consignment.php"><i class="fa fa-list-ul"></i> Create Consignment</a></li>
                                    ...
                                    <div class="col-lg-7">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            <div class="form-group">
                                                                <select name="CONSIGNMENT_TYPE" id="CONSIGNMENT_TYPE" class="form-control">
                                                                    ...
                                                                    <option class="form-control" value='4'>RETAIL</option>
                                                                    <option class="form-control" value='5'>UNDER BOND</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                        ...
                                        <section class="panel panel-default">
                                            <header class="panel-heading">
                                                <span class="hide" id="consignee_user_id"><?php echo $Company->getId();?></span><?php echo $Company->getCompany_name();?>'s BRAND LIST </header>
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <section class="panel panel-default">
                                            <header class="panel-heading">MY CONSIGNMENT ITEM LIST 
                                            </header>
