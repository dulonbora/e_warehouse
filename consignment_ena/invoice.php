...
<?php echo $UI->Work(""); ?>
                ...
                <section id="content">
                    <section class="vbox bg-white">
                        <header class="header bg-light lter hidden-print">
                            <a href="#" class="btn btn-sm btn-info btn-rounded pull-right" onclick="window.print();">Print</a> 
                            <a href="consignment_details.php?i=<?php echo $_id;?>" class="btn btn-sm btn-success btn-rounded pull-right">Back To Consignment</a> 
                            <p>Invoice</p>
                        </header>
    ...
    <li><a href="../consignment_ena/consignment_details.php?i=<?php echo $Transfar_Master->getId();?>"><i class="fa fa-list-ul"></i> Consignment Details / No.<?php echo $Transfar_Master->getId();?></a></li>
    <li><a><i class="fa fa-list-ul"></i> Invoice</a></li>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right" style="width: 60px">TOTAL_MRP</th>
                                    </tr>
                                </thead>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td colspan="6" class="text-right no-border"><strong>VAT Included in Total</strong></td>
