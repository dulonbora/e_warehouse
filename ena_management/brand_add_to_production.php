...
<div class="row wrapper" id="">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h4 class="m-t-none">Transfer your stock
        ...
        <form action=""  method="post" id="ENA_TO_PRRODUCTION" role="form">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="form-group">
                    <label>Transfer To Qnty (BL)</label>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="form-group"> 
                    <label>Item Transection</label> 
                    <select name="IO_TYPE" id="IO_TYPE" class="form-control">
                        <option class="form-control" value=''>Select Transection</option>
                        <option class="form-control" value='L'>Lost</option>
                        <option class="form-control" value='I'>Inward</option>
                        <option class="form-control" value='O'>Outward</option>
                    </select>
                </div>
            </div>
