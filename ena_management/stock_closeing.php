...
<ul class="breadcrumb"> 
    ...
    <li><a href="../ena_management/stock_closeing.php"><i class="fa fa-list-ul"></i> Closeing Stock Summary</a></li>
</ul>                              
                                    ...
                                    <div class="col-lg-12">
                                        <section class="panel panel-default">
                                            <header class="panel-heading">CLOCEING STOCK SUMMARY
...
<script src="stock_closeing_.js"></script>
</body>
