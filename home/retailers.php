                ...
                <div class="col-sm-6">
                   <section class="panel panel-default">
                      ...
                      <div class="list-group no-radius alt"> 
                          <a class="list-group-item" href="../consignment/consignment_list.php?s=1"> <span class="badge bg-info"><?php echo $dataPointsConsignmentImflCount1;?></span> <i class="fa fa-comment icon-muted"></i> Active </a>
                          <a class="list-group-item" href="../consignment/consignment_list.php?s=2"> <span class="badge bg-info"><?php echo $dataPointsConsignmentImflCount2;?></span> <i class="fa fa-envelope icon-muted"></i> Confirmed </a>
                          <a class="list-group-item" href="../consignment/consignment_list.php?s=3"> <span class="badge bg-light"><?php echo $dataPointsConsignmentImflCount3;?></span> <i class="fa fa-eye icon-muted"></i> Order Pending </a>
                          <a class="list-group-item" href="../consignment/consignment_list.php?s=4"> <span class="badge bg-light"><?php echo $dataPointsConsignmentImflCount4;?></span> <i class="fa fa-eye icon-muted"></i> Order Confirmed </a>
                          <a class="list-group-item" href="../consignment/consignment_list.php?s=5"> <span class="badge bg-light"><?php echo $dataPointsConsignmentImflCount5;?></span> <i class="fa fa-eye icon-muted"></i> Invoice Generated </a>
                          <a class="list-group-item" href="../consignment/consignment_list.php?s=6"> <span class="badge bg-light"><?php echo $dataPointsConsignmentImflCount6;?></span> <i class="fa fa-eye icon-muted"></i> Dispatched </a>
                          <a class="list-group-item" href="../consignment/consignment_list.php?s=7"> <span class="badge bg-light"><?php echo $dataPointsConsignmentImflCount7;?></span> <i class="fa fa-eye icon-muted"></i> Excuted </a>
                      </div>
                   </section>
