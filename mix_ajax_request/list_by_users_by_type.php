...
$TotalRow = $_mix->TotalCountByUserByType($userId, $_type);
$limit = 20;
...
$Result = $_mix->loadAllPaggingByUserByType($userId, $_type, $start, $limit);
...
if ($Result > 0) {
    ...
    foreach ($Result as $rows) {
        ...
        $Edict['SUB_UNIT_VALUE']        = $rows['SUB_UNIT_VALUE']       == NULL ? "" : $rows['SUB_UNIT_VALUE'] ;
