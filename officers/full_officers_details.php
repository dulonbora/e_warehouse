                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <section class="panel panel-default">
                                            <header class="panel-heading">Profile Details
                                            </header>     
                                                    ...
                                                    <div class="clearfix">
                                                        <a href="#" class="pull-left thumb-md avatar b-3x m-r">
                                                            ...
                                                            <small class="text-muted text-success">
                                                                <?php echo $company->GenRole($company->getRole());?> / <?php echo $company->GenCompanyType($company->getCompany_type());?> (<?php echo $company->GenerateAction_Officers($company->getStatus());?>)</small>
                                                        </div>
                                                    </div>
                                                </header>
