...
?>
<div class="wrapper"> <h4 class="m-t-none text-capitalize text-success">Update Your Profile Details 
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group"> <label>Designation</label> 
                <select name="COMPANY_TYPE" id="role" class="form-control" <?php echo $__company->getStatus() == 5 ? "disabled" : "";?>>
                    ...
                    <option class="form-control" value='SE'>SUPERINTENDENT</option>
                        <option class="form-control" value='DSE'>DEPUTY SUPERINTENDENT</option>
                        <option class="form-control" value='CE'>COMMISSIONER</option>
                        <option class="form-control" value='ACE'>ADDITIONAL COMMISSIONER</option>
                        <option class="form-control" value='DA'>DEALING ASSISTANT</option>
                        <option class="form-control" value='A'>ADMIN</option>
                    </select>
                </div>
        </div>
