        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="form-group"> <label>Action Type</label> 
                    <select name="ACTION" id="ACTION" class="form-control">
                        <option class="form-control" value='5'>Verified</option>
                        <option class="form-control" value='0'>Pending for verification</option>
                        <option class="form-control" value='2'>On leave</option>
                        <option class="form-control" value='3'>Retired</option>
                        <option class="form-control" value='4'>Suspended</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group"> <label>Officers Name</label> 
                    <input type="text" name="OFFICERS_NAME" id="OFFICERS_NAME" value="<?php echo $__company->getGstn(); ?>" id="GSTN" placeholder="GSTN" class="input-sm form-control" required disabled>
                    <input type="hidden" name="MODULE_TYPE" value="OFF">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group"> <label>NOTE</label>
                    <input type="text" name="NOTE" id="NOTE" value="<?php echo $__company->getGstn(); ?>" id="GSTN" placeholder="GSTN" class="input-sm form-control" required>
                </div>
            </div>
