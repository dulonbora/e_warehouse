...
<?php if ($Brand__List__User_View->getUser_item_status() > 0) { ?>
        ...
        <form action=""  method="post" id="BrandListForm" role="form">
            ...
            <input type="hidden" name="MODE" id="MODE" value="PRODUCED">
            <input type="hidden" name="IO_TYPE" id="IO_TYPE" value="X">

            
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                    <label class="text-danger">Batch No</label>
                    <input type="text" name="BATCH_NO" value="" id="BATCH_NO" placeholder="Batch No" class="input-sm form-control" required>
                </div>
            </div>
