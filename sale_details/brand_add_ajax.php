...
<div class="row wrapper" id="">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h4 class="m-t-none">ADD THE ITEM TO THE CONSIGNMENT LIST 
    ...
    <form action=""  method="post" id="BrandListForm" role="form">
        ...
        <div class="col-lg-12">
                           ...
                           <section class="panel panel-default">
                               <header class="panel-heading"><span id="">Calcluated Details</span> <span class="pull-right text-danger">T = TOTAL</span>
                               </header>
                              <div class="table-responsive">
                                 <table class="table table-striped b-t b-light">
                                    <tbody id="TableBody">
