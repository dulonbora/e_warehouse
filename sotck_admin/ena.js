...
function loadTable() {
    var url = "../ena_ajax_request/load_brand_list_by_stock.php";
    $.ajax({
        type: "GET",
        url: url,
        success: function (data) {
            ...
            if (parseInt(json.SUCCESS) === 1) {
                ...
                for (var i = 0; i < json.CONTENTS.length; i++) {
                    ...
                    output += link
                            ...
                            + "<td class='text-center'><a href='stock_by_company_list_by_item_ena.php?i="+json.CONTENTS[i].ID+"' class='btn btn-danger btn-xs btn-rounded text-danger text brandList' id='" + json.CONTENTS[i].ID + "'>View</a></td></tr>"
