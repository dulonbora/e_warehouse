...
function loadTable() {
    var url = "../ena_management_ajax_request/load_brand_list_by_item_id.php?id="+item_id+"&i="+page_no;
    $.ajax({
        type: "GET",
        url: url,
        ...
        success: function (data) {
            ...
            if (parseInt(json.SUCCESS) === 1) {
                ...
                for (var i = 0; i < json.CONTENTS.length; i++) {
                    var link = "<tr><td><a href='index.php?i=" + json.CONTENTS[i].ID + "'>" + json.CONTENTS[i].USER_ID + "</a></td>";
                    output += link
                            ...
                            + "<td class='text-center'><a href='ena_transection.php?i="+json.CONTENTS[i].ID+"' class='btn btn-danger btn-xs btn-rounded text-danger text brandList' id='" + json.CONTENTS[i].ID + "'>View</a></td></tr>"
