...
$_type = filter_input(INPUT_GET , "t");
...
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 m-b-xs">
                                    ...
                                    <div class="btn-group"> 
                                         <a href="stock_by_company_list_by_item_imfl_type.php?i=<?php echo $_id;?>&t=MNF" class="btn btn-sm btn-default btn-block">Manufactory</a>
                                    </div>
...
<script src="stock_by_company_list_by_ite_imfl_type.js"></script>
</body>
